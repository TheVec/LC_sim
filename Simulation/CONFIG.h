...
#define INITIAL_SURFACE_TEMPERATURE 286.0 //Kelvin
#define DISPLAY_DEPTH 25.0
#define DELTA_X (DEPTH/(RESOLUTION - 1)) //spatial step
#define FRAMES_PER_YEAR (52)
#define TIMESTEPS_PER_FRAME 4000
#define DELTA_T (86400.0 * 365.2422 / (FRAMES_PER_YEAR * TIMESTEPS_PER_FRAME)) //seconds
#define YEAR_COUNT 16
#define START_SAVE_YEAR 8
...
#define HEAT_CAPACITY 5e6 //J/(m^3 K)
